...
from markupsafe import Markup  # Fixed import
import numpy as np
import pandas as pd
...
@app.route('/')
def home():
    return render_template('index.html', title='Smart Agriculture Advisor - Home')

# Crop recommendation form page
@app.route('/crop-recommend')
def crop_recommend():
    return render_template('crop.html', title='Smart Agriculture Advisor - Crop Recommendation')

# Fertilizer recommendation form page
@app.route('/fertilizer')
def fertilizer_recommendation():
    return render_template('fertilizer.html', title='Smart Agriculture Advisor - Fertilizer Suggestion')
...
def fert_recommend():
    ...
    key = "Nlow" if n > 0 else "NHigh" if max_value == "N" else \
          "Plow" if p > 0 else "PHigh" if max_value == "P" else \
          "Klow" if k > 0 else "KHigh"
